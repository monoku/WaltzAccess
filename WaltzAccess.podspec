...
Pod::Spec.new do |s|
  ...
  s.author             = { "Guillaume Vachon" => "guillaume.vachon@waltzapp.com" }
  # Or just: s.author    = "Guillaume Vachon"
  # s.authors            = { "Guillaume Vachon" => "guillaume.vachon@waltzapp.com" }
  # s.social_media_url   = "http://twitter.com/Guillaume Vachon"
  ...
  s.source       = { :git => "https://github.com/monoku/WaltzAccess.git", :tag => "#{s.version}" }
